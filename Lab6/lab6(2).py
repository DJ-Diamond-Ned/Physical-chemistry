...
def equation(x):
    ...
    p_H2  = y_H2  * P_total_0
    p_CO  = y_CO  * P_total_0
    p_H2O = y_H2O * P_total_0
    p_CO2 = y_CO2 * P_total_0
...
y_H2_eq = y_H2_0 + x_sol
y_CO_eq  = y_CO_0 - x_sol
y_H20_eq  = y_H2O_0 - x_sol
y_CO2_eq  = y_CO2_0 + x_sol

print(f"\nРавновесные мольные доли:")
print(f"  y_H2 = {y_H2_eq:.6f}")
print(f"  y_CO  = {y_CO_eq:.6f}")
print(f"  y_H2O  = {y_H20_eq:.6f}")
print(f"  y_CO2  = {y_CO2_eq:.6f}")
print(f"Сумма = {y_H2_eq + y_CO_eq + y_H20_eq + y_CO2_eq:.6f}")
